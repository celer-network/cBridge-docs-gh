...
description: >-
  ...
  on-chain.  Then cBridge PeggedTokenBridge contract will mint corresponding
  assets to user's address on source chain
---
...
Here is the <mark style="color:red;">abi</mark> for PeggedTokenBridge: [https://github.com/celer-network/cBridge-typescript-client/tree/main/contract/abi/pegged/PeggedTokenBridge.sol](https://github.com/celer-network/cBridge-typescript-client/tree/main/contract/abi/pegged/PeggedTokenBridge.sol)
